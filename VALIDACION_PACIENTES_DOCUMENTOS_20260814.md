...
La firma contractual se validó mediante una transacción reversible: Manuel se mostró como `firmado` con hora de firma en el período seleccionado, sin conservar la firma de prueba. El DNI del paciente es editable y la duración de hemodiálisis se restringe a 3–3,5 horas. La epicrisis ahora permite seleccionar y arrastrar bloques A4; los bloques de diagnóstico y dosis admiten alineación y justificación, y la misma configuración se aplica al PDF. El conjunto Vitest finalizó con 13 pruebas correctas.
