...
const state = { registers: [], schedule: [], report: [], monthlySchedule: [], reminders: [], calendarDate: null, professionalSearch: [] };
...
function init() {
  ...
  if (["registro", "turnos", "reportes", "horario-mensual", "movil"].includes(requestedTab)) activeTab(requestedTab);
  loadRegisters(); loadSchedule(); generateMonthlySchedule();
}
init();
