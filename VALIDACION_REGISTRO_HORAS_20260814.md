...
La búsqueda previa se comprobó al escribir `DE LA CRUZ` en el ingreso rápido. Antes de registrar, la pantalla mostró coincidencias con nombre, DNI disponible, turno y secuencia LMV. La coincidencia de Guillermina De la Cruz Serna recuperó correctamente Turno I; los perfiles sin DNI quedaron señalados para completar el documento antes de marcarlos.
