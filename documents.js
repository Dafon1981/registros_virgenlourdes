(() => {
  ...
  function drawEpicrisis(pdf, patient, config, signature, backgroundData, signatureData) {
    ...
    pdfText(pdf, text("titulo"), config.titulo, true);
    pdfText(pdf, text("paciente"), config.paciente);
    pdfText(pdf, text("dni"), config.dni);
    pdfText(pdf, text("edad"), config.edad);
    pdfText(pdf, text("fecha"), config.fecha);
    pdfText(pdf, text("diagnostico"), config.diagnostico);
    pdfText(pdf, text("dosis"), config.dosis, true);
    ...
    else pdfText(pdf, text("firma"), config.firma);
    pdfText(pdf, text("firmante"), config.firmante, true);
  }
